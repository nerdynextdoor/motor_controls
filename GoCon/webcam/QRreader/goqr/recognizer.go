...
func (q *recognizer) setupQrPerspective(index int) {
	...
	// fmt.Printf("point1  %v \n", q.capstones[qr.caps[1]].corners[2])
	// fmt.Printf("point2  %v \n", q.capstones[qr.caps[2]].corners[3])
	// fmt.Printf("point3  %v \n", qr.align)
	// fmt.Printf("point4  %T \n", q.capstones[qr.caps[0]].corners[1])

	//fmt.Printf("rect  %T \n",rect)
	// fmt.Printf("GVX  %T \n",GVX)
	 GVX[0] = q.capstones[qr.caps[1]].corners[0]
	 GVX[1] = q.capstones[qr.caps[2]].corners[1]
	 GVX[2] = qr.align
	 GVX[3] = q.capstones[qr.caps[0]].corners[3]

	fmt.Printf("main bolder  %v \n", GVX[:])
